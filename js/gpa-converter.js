(function () {
  ...
  var KEY = "sc_conv_rows", SKEY = "sc_conv_meta";
  ...
  function exportReport() {
    ...
    if (tCr === 0) { SC.toast("Add courses first", "error"); return; }
    ...
    report.innerHTML = '<div style="font-family:sans-serif;padding:40px;color:#000;background:#fff">' +
      ...
      'Generated by Scholarics. This is an unofficial conversion for guidance only.' +
      '</p></div>';
    window.print();
  }
