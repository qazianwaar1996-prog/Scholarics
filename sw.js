...
var CACHE_NAME = 'scholarics-shell-037b055e'; /* rebrand to Scholarics: new cache name force-evicts all legacy caches on activate */
...
/* Assets to pre-cache on install (the app shell).
   ...
   Fingerprinted bundles contain:
     ...
     /assets/js/g-ca0b60.08de92d3.js  ←  /js/script.js, /js/personalization.js, /js/premium.js, /js/sc-shell.js, /js/sc-v2-features.js, /js/analytics.js, /js/consent.js, /js/email-capture.js, /js/pwa.js
     /assets/css/core-3.06a13263.css  ←  /css/style.css, /css/premium.css, /css/personalization.css
     /assets/js/core-shell-person-prem-ga-consent-pwa.fb816b71.js  ←  /js/script.js, /js/sc-shell.js, /js/personalization.js, /js/premium.js, /js/analytics.js, /js/consent.js, /js/pwa.js
     ...
     /assets/js/g-9e103f.3822adb7.js  ←  /js/personalization.js, /js/premium.js, /js/sc-shell.js, /js/sc-v2-features.js, /js/analytics.js, /js/consent.js, /js/email-capture.js, /js/pwa.js
